...
namespace ASD {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(int Id, string FirstName, string LastName, string Email, string Password, bool Type) {
...
namespace ASD.DatabaseDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Id], [FirstName], [LastName], [Email], [Password], [T" +
                "ype]) VALUES (@Id, @FirstName, @LastName, @Email, @Password, @Type);\r\nSELECT Id," +
                " FirstName, LastName, Email, Password, Type FROM Users WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email, [Password] = @Password, [Type] = @Type WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)));
SELECT Id, FirstName, LastName, Email, Password, Type FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ASD.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Email, Password, Type FROM dbo.Users";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Password, global::System.Nullable<bool> Original_Type) {
            ...
            if ((Original_Type.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((bool)(Original_Type.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string FirstName, string LastName, string Email, string Password, global::System.Nullable<bool> Type) {
            ...
            if ((Type.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((bool)(Type.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string FirstName, string LastName, string Email, string Password, global::System.Nullable<bool> Type, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Password, global::System.Nullable<bool> Original_Type) {
            ...
            if ((Type.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((bool)(Type.Value));
            }
            else {
            ...
            if ((Original_Type.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((bool)(Original_Type.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string Password, global::System.Nullable<bool> Type, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Password, global::System.Nullable<bool> Original_Type) {
            return this.Update(Original_Id, FirstName, LastName, Email, Password, Type, Original_Id, Original_FirstName, Original_LastName, Original_Email, Original_Password, Original_Type);
        }
    }
